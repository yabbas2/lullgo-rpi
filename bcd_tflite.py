...
class BCD:
    ...
    async def bcd_main(self):
        ...
        base_options = core.BaseOptions(file_name=self.model_path, use_coral=False, num_threads=self.cpu_threads)
        classification_options = processor.ClassificationOptions(max_results=self.max_nof_results, score_threshold=self.score_threshold)
